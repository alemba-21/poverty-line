  ...
  return (
    <div className='flex justify-between items-center h-24  mx-auto px-4 text-black bg-zinc-50 drop-shadow-lg'>
      ...
      <ul className='hidden md:flex flex-row text-xl md:justify-center'>
        ...
        <Link to="/signin">  
            <button className='text-white border hidden m-auto bg-green-600 w-[110px] ml-2 py-2 px-4 h-[50px] text-center border-green-600 hover:bg-transparent hover:text-green-600 rounded-full' onClick={ handleLogout }>Logout</button>
        </Link>          
      </ul>
      </div>
